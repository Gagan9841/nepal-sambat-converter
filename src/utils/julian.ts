 ...
 * This function implements the algorithm to convert a Gregorian date to its corresponding JD.
 * It handles the Gregorian calendar reform of 1582 (after October 4, 1582, 10 days were skipped).
 *
 ...
 *
 * @example
 * // Returns the Julian Day for October 15, 1582 (first day of Gregorian calendar)
 * gregorianToJD(1582, 10, 15);
 */
